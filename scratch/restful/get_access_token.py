...
def get_token():
    ...
    get_access_token_url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=d04dd7c764cc9b348d390eb81340a778&code='+ code +'&grant_type=authorization_code'
